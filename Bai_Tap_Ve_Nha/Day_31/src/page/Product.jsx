...
export default function Product() {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-linear-to-tr from-blue-50 to-purple-100">
        <Loading />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-black bg-linear-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text mb-4 tracking-tight">
            Bộ Sưu Tập Sản Phẩm
          </h1>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-24">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-linear-to-br from-blue-100 to-purple-100 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {currentProducts.map((product, index) => (
                ...
                >
                  ...
                  >
                    <div className="relative h-64 w-full bg-linear-to-br from-gray-100 to-gray-200 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="flex-1 flex flex-col justify-between p-6">
                    <div>
                      ...
                      <h2
                        className="text-lg font-bold text-gray-800 mb-3 line-clamp-2 min-h-14 group-hover:text-blue-600 transition-colors"
                        title={
                          product.product_name || product.title || product.name
                        }
                      >
                      ...
                      <div className="flex items-baseline gap-2 mb-4">
                        <span className="text-2xl font-black text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-pink-600">
